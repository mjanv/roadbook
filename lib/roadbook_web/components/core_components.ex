defmodule RoadbookWeb.CoreComponents do
  @moduledoc """
  ...
  This function accepts all HTML input types, considering that:
    ...
    * For live file stages, see `Phoenix.Component.live_file_input/1`
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RoadbookWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RoadbookWeb.Gettext, "errors", msg, opts)
    end
  end
